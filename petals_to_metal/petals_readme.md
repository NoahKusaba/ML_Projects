...
* Fun experiment notebook using progressive training by using lower resolution images to begin with, and progressively using higher resolution images across epochs, to optimize training time
* Didn't end up using this technique in final_submission